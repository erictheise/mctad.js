...
describe('meanDirection', function() {
  ...
  it('can get the meanDirection of a biased roulette wheel', function() {
      assert.closeTo(mctad.meanDirection(['43°', '45°', '52°', '61°', '75°', '88°', '88°', '279°', '357°']), mctad.toRadians('51°'), 0.001);
  });
});
